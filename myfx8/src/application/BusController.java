...
public class BusController {
    ...
    void onClickCheck(ActionEvent event) {
 		try {
			root = FXMLLoader.load(getClass().getResource("BusCheck.fxml"));
			Scene scene = new Scene(root,1000,800);
			BusTicket.primaryStage.setScene(scene);
			BusTicket.primaryStage.show();
    ...
    void onClickUpdate(ActionEvent event) {
		try {
			root = FXMLLoader.load(getClass().getResource("BusUpdate.fxml"));
			Scene scene = new Scene(root,1000,800);
			BusTicket.primaryStage.setScene(scene);
			BusTicket.primaryStage.show();
		} catch(Exception e) {
